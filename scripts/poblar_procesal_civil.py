# Archivo: scripts/poblar_procesal_civil.py (Versión Corregida)
...
load_dotenv()
# --- CONFIGURACIÓN ---
COLECCION = "colepa_procesal_civil_final"
ARCHIVO_JSON_ENTRADA = os.path.join(os.path.dirname(__file__), '..', 'data', 'procesal_civil_data.json')
NOMBRE_LEY_PAYLOAD = "Código Procesal Civil"
...
def poblar_base_de_datos():
    ...
    for i, articulo in enumerate(lista_articulos):
        ...
        # Ahora leemos los datos de contexto directamente desde 'articulo'
