# Archivo: scripts/poblar_penal.py
...
load_dotenv()
# --- CONFIGURACIÓN ---
COLECCION = "colepa_penal_final"
ARCHIVO_JSON_ENTRADA = os.path.join(os.path.dirname(__file__), '..', 'data', 'penal_data.json')
NOMBRE_LEY_PAYLOAD = "Código Penal"
