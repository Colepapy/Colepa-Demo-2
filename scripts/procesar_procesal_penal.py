# Archivo: scripts/procesar_procesal_penal.py
...
# --- CONFIGURACIÓN ---
NOMBRE_PDF_ENTRADA = "Código Procesal Penal-Texto Consolidado.pdf"
DIRECTORIO_DATA = os.path.join(os.path.dirname(__file__), '..', 'data')
ARCHIVO_JSON_SALIDA = os.path.join(DIRECTORIO_DATA, 'procesal_penal_data.json')
...
def extraer_texto_pdf(ruta_pdf):
    ...
    try:
        ...
        texto_completo = ""
        # <-- CAMBIO: Empezamos desde la página 7 (índice 6) para este PDF
        for num_pagina in range(6, len(documento)):
...
def limpiar_texto(texto):
    ...
    textos_a_eliminar = [
        ...
        r"Texto consolidado de la Ley N° 1286/1998",
...
def procesar_y_estructurar(texto_limpio):
    # Este código tiene una estructura similar al Procesal Civil
