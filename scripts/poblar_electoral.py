# Archivo: scripts/poblar_electoral.py
...
load_dotenv()
# --- CONFIGURACIÓN ---
COLECCION = "colepa_electoral_final"
ARCHIVO_JSON_ENTRADA = os.path.join(os.path.dirname(__file__), '..', 'data', 'electoral_data.json')
NOMBRE_LEY_PAYLOAD = "Código Electoral"
