# Archivo: scripts/procesar_procesal_civil.py
...
# --- CONFIGURACIÓN ---
NOMBRE_PDF_ENTRADA = "Código Procesal Civil-Texto Consolidado.pdf"
DIRECTORIO_DATA = os.path.join(os.path.dirname(__file__), '..', 'data')
ARCHIVO_JSON_SALIDA = os.path.join(DIRECTORIO_DATA, 'procesal_civil_data.json')
...
def extraer_texto_pdf(ruta_pdf):
    ...
    try:
        ...
        texto_completo = ""
        # Rango de páginas para el Código Procesal Civil (inicia en pág. 9)
        for num_pagina in range(8, len(documento)):
...
def limpiar_texto(texto):
    ...
    textos_a_eliminar = [
        ...
        r"Texto consolidado de la Ley N° 1337/1988",
