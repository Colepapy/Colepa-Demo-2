# Archivo: scripts/procesar_penal.py
...
# --- CONFIGURACIÓN ---
NOMBRE_PDF_ENTRADA = "Código Penal-Texto Consolidado.pdf"
DIRECTORIO_DATA = os.path.join(os.path.dirname(__file__), '..', 'data')
ARCHIVO_JSON_SALIDA = os.path.join(DIRECTORIO_DATA, 'penal_data.json')
...
def extraer_texto_pdf(ruta_pdf):
    ...
    try:
        ...
        texto_completo = ""
        # <-- CAMBIO: Empezamos desde la página 8 (índice 7) para este PDF
...
def limpiar_texto(texto):
    ...
    textos_a_eliminar = [
        ...
        r"Texto consolidado de la Ley N° 1160/1997",
...
def procesar_y_estructurar(texto_limpio):
    # Este código tiene una estructura similar al Procesal Penal
