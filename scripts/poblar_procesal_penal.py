# Archivo: scripts/poblar_procesal_penal.py (Versión Corregida)
...
load_dotenv()
# --- CONFIGURACIÓN ---
COLECCION = "colepa_procesal_penal_final"
ARCHIVO_JSON_ENTRADA = os.path.join(os.path.dirname(__file__), '..', 'data', 'procesal_penal_data.json')
NOMBRE_LEY_PAYLOAD = "Código Procesal Penal"
...
def poblar_base_de_datos():
    ...
    for i, articulo in enumerate(lista_articulos):
        ...
        # Ahora leemos los datos de contexto directamente desde 'articulo' usando .get()
        puntos.append(models.PointStruct(
            ...
            payload={
                ...
                "seccion": articulo.get('seccion', 'N/A')
            }
        ))
