# Archivo: scripts/procesar_laboral_final.py
...
# --- CONFIGURACIÓN ---
NOMBRE_PDF_ENTRADA = "Código Laboral-Texto Consolidado.pdf"
DIRECTORIO_DATA = os.path.join(os.path.dirname(__file__), '..', 'data')
ARCHIVO_JSON_SALIDA = os.path.join(DIRECTORIO_DATA, 'laboral_data.json')
...
def extraer_texto_pdf(ruta_pdf):
    ...
    try:
        ...
        texto_completo = ""
        # Rango de páginas para el Código Laboral (inicia en pág. 5)
        for num_pagina in range(4, len(documento)):
...
def limpiar_texto(texto):
    ...
    textos_a_eliminar = [
        ...
        r"Texto consolidado de la Ley N° 213/1993",
...
def procesar_y_estructurar(texto_limpio):
    ...
    for linea in lineas:
        ...
        # <-- CAMBIO CLAVE: Buscamos la palabra completa "Artículo"
