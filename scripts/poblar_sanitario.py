# Archivo: scripts/poblar_sanitario.py (Versión Corregida)
...
load_dotenv()
# --- CONFIGURACIÓN ---
COLECCION = "colepa_sanitario_final"
ARCHIVO_JSON_ENTRADA = os.path.join(os.path.dirname(__file__), '..', 'data', 'sanitario_data.json')
NOMBRE_LEY_PAYLOAD = "Código Sanitario"
...
def poblar_base_de_datos():
    ...
    for i, articulo in enumerate(articulos_validos):
        ...
        # Leemos los datos directamente de 'articulo' usando .get() para más seguridad
